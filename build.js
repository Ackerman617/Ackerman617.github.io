...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Ackerman | Personal Journal & Creative Thoughts</title>
    <meta name="description" content="Personal blog of Ackerman. Reflections on minimalist design, coding, editorial aesthetics and creative writing.">
    ...
    <main class="main-content home-layout">
        ...
        <section class="left-column">
            <div class="bio-sticky">
                ...
                <p class="bio-role">Developer & Minimalist</p>
                <p class="bio-description">
                    探索技术深处，追求设计之美。这里记录了我对程序设计、极简主义以及数字美学的思考与沉淀。
                </p>
                <div class="bio-links">
